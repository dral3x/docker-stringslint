...
# use copier
override COPIER_ARTIFACTS=copier/stringslint_linux_amd64.tar.gz copier/stringslint_linux_arm64.tar.gz
copier/stringslint_linux_%.tar.gz: latest ; docker run --platform linux/$* --rm $(if $(IMAGE_NAME),$(IMAGE_NAME),latest) archive-stringslint-runtime > $@
